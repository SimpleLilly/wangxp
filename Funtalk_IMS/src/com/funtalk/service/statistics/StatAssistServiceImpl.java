...
import com.funtalk.dao.statistics.StatAssistDao;
import com.funtalk.common.SpringContextUtil;

public class StatAssistServiceImpl implements StatAssistService{
	

    private static final Log log = LogFactory.getLog(StatAssistServiceImpl.class);

    StatAssistDao statAssistDao;
    

	
	public String upLoadSettleExcel(Map params) {
		

    	List developUsers = statAssistDao.upLoadSettleExcel(params);
    ...
    */  
	...
	public void setStatAssistDao(StatAssistDao statAssistDao){
		
		this.statAssistDao=statAssistDao;
	}
